...
dependencies {
	...
	modImplementation ("maven.modrinth:freecam-stationapi:${project.properties["freecam-stapi_version"]}")

	modImplementation ("maven.modrinth:creativeeditorwands-stationapi:${project.properties["creativewands_version"]}")
